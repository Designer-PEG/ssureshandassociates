          ...
          <form onSubmit={handleSubmit} className="mt-8 max-w-md mx-auto bg-white p-6 rounded-xl border border-gray-100 shadow-lg text-left">
            <div className="flex flex-col gap-3">
              <div>
                ...
                />
                {error && (
                  <p id="cta-email-error" className="mt-2 text-xs font-semibold text-red-600 text-left flex items-center gap-1">
            ...
            {isSubmitted && (
              <div className="mt-4 p-3 bg-emerald-50 text-emerald-800 rounded-lg text-xs font-semibold flex items-center justify-center gap-1.5 border border-emerald-100">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-emerald-600 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
